...
<body>
    ...
    <div class="container">
        <div class="row">
            <div class="col">
                <h1 class="d-flex justify-content-center">Tampil Data Dosen</h1>
            </div>
        </div>
        <br><br>
        <div class="row">
            <div class="col">
                <div class="d-flex justify-content-between">
                    <div class="p-2"><a href="tambah_dosen.php" class="btn btn-primary">Tambah Data Dosen</a></div>
                    <div class="p-2"><a href="cetak_data_dosen.php" class="btn btn-primary">Cetak Data Dosen</a></div>
                </div>
            </div>
        </div>
        <div class="row">
                <table class="table table-bordered">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                <a class="btn btn-primary" href="ubah_dosen.php?id=<?= $dsn->nip ?>">UBAH</a> | 
                                <a class="btn btn-danger" href="hapus_dosen.php?id=<?= $dsn->nip ?>" 
