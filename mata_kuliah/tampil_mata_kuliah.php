...
<body>
    ...
    <div class="container">
        <div class="row">
            <div class="col">
                <h1 class="d-flex justify-content-center">Tampil Data Mata Kuliah</h1>
            </div>
        </div>
        <div class="row">
            <div class="col">
                <div class="d-flex justify-content-between">
                    <div class="p-2"><a href="tambah_mata_kuliah.php" class="btn btn-primary">Tambah Data Mata Kuliah</a></div>
                    <div class="p-2"><a href="cetak_data_mata_kuliah.php" class="btn btn-primary">Cetak Data Mata Kuliah</a></div>
                </div>
            </div>
        </div>
        <div class="row">
            <table class="table table-bordered">
                ...
                <tr>
                    ...
                    <td><?= $mk->pengajar ?></td>
                    <td>
                        <a class="btn btn-primary" href="ubah_mata_kuliah.php?id=<?= $mk->kode_mk ?>">UBAH</a> | 
                        <a class="btn btn-danger" href="hapus_mata_kuliah.php?id=<?= $mk->kode_mk ?>" 
